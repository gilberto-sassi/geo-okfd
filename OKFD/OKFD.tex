...
\author{\name{Gilberto Pereira Sassi (corresponding author)$^{a}$, Chang Chiann$^{b}$}
\affil{$^{a}$Federal University of Bahia, Salvador, Bahia -- Brazil; $^{b}$University of São Paulo, São Paulo, São Paulo -- Brazil}
}
...
\BeginKnitrBlock{theorem}[\cite{giraldo2011ordinary}]
\protect\hypertarget{thm:sistLinear}{}{\label{thm:sistLinear} \iffalse (\cite{giraldo2011ordinary}) \fi{} }Under some regularity conditions, solving the nonlinear optimization problem
\begin{equation*}
...
\addcontentsline{toc}{subsection}{Results from simulation in the second scenario}
...
\begin{center}\includegraphics[width=0.75\linewidth]{figure/mse_app} \end{center}
...
\begin{center}\includegraphics[width=0.75\linewidth]{figure/log_mse_app} \end{center}
